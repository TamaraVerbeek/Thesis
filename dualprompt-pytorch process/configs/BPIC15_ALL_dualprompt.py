# -*- coding: utf-8 -*-
"""
Created on Wed Dec  6 11:43:14 2023
...
def get_args_parser(subparsers):
    ...
    # Model parameters
    subparsers.add_argument('--model', default='BPIC15_ALL', type=str, metavar='MODEL', help='Name of model to train')
    subparsers.add_argument('--input-size', default=970, type=int, help='input size')
    ...
    subparsers.add_argument('--dataset', default='BPIC15_ALL', type=str, help='dataset name')
