...
if __name__ == '__main__':
    ...
    parser.add_argument('--nproc_per_node', type=int, default=1,
        help='number of GPUs')
    parser.add_argument('--dataset', type=str, default='BPIC15_ALL_dualprompt',
        help='dataset')
    parser.add_argument('--model', type=str, default='BPIC15_ALL')
    ...
    elif args_o.dataset == 'BPIC15_ALL_dualprompt':
